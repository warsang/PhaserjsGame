var game =  new Phaser.Game(800, 600, Phaser.CANVAS, 'phaser-teasing', { preload: preload, create: create, update: update, render: render });
...
//Collision des tiles
  ...
  stars.create(75, 592, 'star');
  stars.create(699, 688, 'star');
  stars.create(585, 960, 'star');
  stars.create(421, 960, 'star');
  stars.create(64, 176, 'star');
